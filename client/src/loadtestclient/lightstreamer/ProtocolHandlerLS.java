...
public class ProtocolHandlerLS extends ProtocolHandler {
    ...
    public ProtocolHandlerLS(BasicWSClient basicWSClient,String server, String adapter, long keepaliveMillis) {
    ...
    public void open() {
        try {
            this.networkHandler.open(new URI("ws://" +server + "/lightstreamer"));
        } catch (Exception e) {
        }
    }
